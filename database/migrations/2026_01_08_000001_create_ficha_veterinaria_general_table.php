...
class CreateFichaVeterinariaGeneralTable extends Migration
{
    public function up()
    {
        Schema::create('ficha_veterinaria_general', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('ficha_veterinaria_general');
    }
}
